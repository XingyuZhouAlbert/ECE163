...
class VehicleGeometry():
	...
	def getNewPoints(self, x, y, z, yaw, pitch, roll):
		...
		E2DCM = Rotations.euler2DCM(yaw,pitch,roll)
		new1 = MatrixMath.matrixMultiply(self.vertices, E2DCM)
		new2 = MatrixMath.matrixOffset(new1, x, y, z)
		newPoints = Rotations.ned2enu(new2)
